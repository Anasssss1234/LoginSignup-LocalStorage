...
export default function PasswordModal() {
    ...
    const handleSave=()=>{
        const handleSave=JSON.parse(localStorage.getItem('user'));
        if(handleSave.password==data.password){
             handleSave.password = input.password
           localStorage.setItem("user", JSON.stringify(handleSave));
